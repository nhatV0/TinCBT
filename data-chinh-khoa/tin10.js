...
window.courseContent = [
    ...
    },
    {
        ...
        lessons: [
            ...
            &lt;khối lệnh&gt;</pre>
                            <p>Khi thực hiện, ở mỗi vòng lặp biến <code>i</code> sẽ được gán lần lượt các giá trị trong vùng giá trị của lệnh <code>range()</code>. <strong>Lưu ý:</strong> Khối lệnh lặp phải được viết lùi vào (indent) so với dòng chứa lệnh <code>for</code>.</p>
